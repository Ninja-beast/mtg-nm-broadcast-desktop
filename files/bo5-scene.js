...
window.overlayScenes.bo5 = (function(){
	...
	function render(data){
		...
		// Klokken styres na utelukkende av den egne direkte klient-hentingen
		// i bo5.html (som poller lifecounter-appen direkte i nettleseren,
		// uavhengig av doGet/regnearket). Denne filens egen lokale
		// nedtellings-logikk (handleTimer over) skrev til samme element
		// hvert sekund og kjempet mot den nye direkte hentingen - det var
		// arsaken til at klokken blinket mellom riktig tid og en gammel/
		// lokalt beregnet verdi.
